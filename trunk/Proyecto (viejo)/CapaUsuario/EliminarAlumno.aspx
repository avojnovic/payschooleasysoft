<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarAlumno.aspx.cs" Inherits="UI.EliminarAlumno" %>
    ...
    <div>
        ...
        <table class="style2">
            <tr>
                ...
                <asp:Label ID="alumnoInexistentelb" runat="server" ForeColor="Red" 
                    style="font-family: 'Lucida Console'; font-size: small" 
                    Text="*Alumno inexistente" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style3">
            ...
            <tr>
                ...
                <td style="text-align: right">
                    <asp:Button ID="eliminarbtn" runat="server" Text="Eliminar" 
                        onclick="eliminarbtn_Click" CssClass="style4" />
                    <span class="style4">&nbsp;
                    </span>
