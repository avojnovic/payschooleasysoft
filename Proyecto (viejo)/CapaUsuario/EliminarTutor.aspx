<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarTutor.aspx.cs" Inherits="UI.EliminarTutor" %>
...
<body>
    ...
    <table class="style2">
        ...
        <tr>
            ...
            &nbsp;
                <asp:Label ID="tutorInexistentelb" runat="server" ForeColor="Red" 
                    style="font-family: 'Lucida Console'; font-size: small" 
                    Text="*Tutor inexistente" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style3">
        ...
        <tr>
            ...
            <td style="text-align: right">
                <asp:Button ID="eliminarbtn" runat="server" Text="Eliminar" CssClass="style4" 
